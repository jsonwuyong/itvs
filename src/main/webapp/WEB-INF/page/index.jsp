...
<head>
    ...
    <link href="../hcss/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="../hcss/font-awesome.min.css?v=4.4.0" rel="stylesheet">
    <link href="../hcss/animate.css" rel="stylesheet">
    <link href="../hcss/style.css?v=4.1.0" rel="stylesheet">
</head>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <img alt="image" style="width: 60px;height: 60px" class="img-circle m-t-xs img-responsive" src="../img/a1.jpg">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="./graph_sparkline">Sparkline</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="./graph_metrics">图表组合</a>
                            </li>
                        </ul>
                    </li>
                    <li class="line dk"></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="./photo">我的相册</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="./index_v1" frameborder="0" data-id="index_v1.jsp" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
